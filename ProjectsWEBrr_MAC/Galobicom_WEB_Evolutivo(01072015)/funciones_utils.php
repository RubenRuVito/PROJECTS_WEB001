...
function updatesTablaEquipos($idEquipoA,$idEquipoB,$golA,$golB){ //Método para informar la tabla equipos, partiendo de  
	...
	$editGolAcontra = $regEquipo['gol_contra']+$golB;
        $editGolBcontra = $regEquipo['gol_contra']+$golA;
        if($quiniela==0){
            ...
            if($flagActualizado == 0){
               ...
               // echo "<p>Quini: ".$quiniela." Puntos: ".$editPunt." Jugados: ".$editJug." Ganados: ".$editGan." G.favor: ".$editGolA." G.contra: ".$editGolAcontra."</p>";
                $updateEqui = $conect->query("UPDATE equipos SET puntos='$editPunt',jugados='$editJug',ganados='$editGan',gol_favor='$editGolA',gol_contra='$editGolAcontra' WHERE id_equipo='$idEquipo'; ");
               ...
               // echo "<p>Quini: ".$quiniela." Puntos: ".$editPunt." Jugados: ".$editJug." Perdidos: ".$editPerd." G.favor: ".$editGolB." G.contra: ".$editGolBcontra."</p>";
                $updateEqui = $conect->query("UPDATE equipos SET jugados='$editJug',perdidos='$editPerd',gol_favor='$editGolB',gol_contra='$editGolBcontra' WHERE id_equipo='$idEquipo'; ");
            }
        }else{
            if($flagActualizado == 0){
                $editPerd = $regEquipo['perdidos']+1;
               // echo "<p>Quini: ".$quiniela." Puntos:  Jugados: ".$editJug." Perdidos: ".$editPerd." G.favor: ".$editGolA." G.contra: ".$editGolAcontra."</p>";
                $updateEqui = $conect->query("UPDATE equipos SET jugados='$editJug',perdidos='$editPerd',gol_favor='$editGolA',gol_contra='$editGolAcontra' WHERE id_equipo='$idEquipo'; ");
                $flagActualizado++;//El siguiente update el flujo se dirija al else para hacer el update(Ganador) Al equipo Visitante.  
            }else{
                $editPunt = $regEquipo['puntos']+3;
                $editGan = $regEquipo['ganados']+1;
               // echo "<p>Quini: ".$quiniela." Puntos: ".$editPunt." Jugados: ".$editJug." Ganados: ".$editGan." G.favor: ".$editGolB." G.contra: ".$editGolBcontra."</p>";
                $updateEqui = $conect->query("UPDATE equipos SET puntos='$editPunt',jugados='$editJug',ganados='$editGan',gol_favor='$editGolB',gol_contra='$editGolBcontra' WHERE id_equipo='$idEquipo'; ");
