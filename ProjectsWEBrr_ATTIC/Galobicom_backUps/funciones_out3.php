	...
	if($consUsuario && $consUsuarioTemp){
		if(mysqli_num_rows($consUsuario)===1){
			...
			if(mysqli_num_rows($consUsuarioTemp)===1){
				...
				$insert = $conexion->query("INSERT INTO users_temp (id_user,nombre,apellidos,nick,email,password,cod_activacion) VALUES ('$idUserReg','vacio','vacio','vacio','$emailReg','$nuevoPass','$codigoReseteo');");
