...
?>
	<canvas id="theMatrix" width="1145" height="200"></canvas>
	<div class="navbar-inverse jumbotron" style="border-radius: 10px;">
	  <h1 style="color: #777;">Crea tu cuenta en Galobicom</h1>
	  <p>Registrate y hazte Galobic@ digital, una vez dentro tendrás acceso a las utilidades de la comunidad.</p>
	  <p><a class="btn btn-success btn-md" role="button" href="formRegistro.php">Regístrate!</a></p>
	</div>
	  ...
	  <div class="col-sm-6 col-md-4">
	    <div class="navbar-inverse thumbnail" style="border-radius: 10px;">
	      ...
	      <div class="caption">
	        ...
	        <p>Si estás conquistando el mundo, y quieres contarnoslo, aqui tienes un epacio en el que informar
	        	a la camadería Galobica de tus hazañas y anecdotas más locuelieskas..!!</p>
