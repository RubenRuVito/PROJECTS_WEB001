...
$(document).ready(function(){ //Sistema Jquery y Ajax para recoger variables trás un evento de un atributo.
    ...
    //var pintarDivJugadoresGolKO = "<div id='divFormGroupNumJugol' class='form-group'></div>";
...
var idJugadoresGol = [];
var goles = [];
function valoresIdJugadoresGol(valor){
    idJugadoresGol.push(valor.value);
    alert(idJugadoresGol);
}
    ...
    if(numJortext.indexOf('Configurar')!= -1){ //significa q contiene la cadena..
        if(fecHora > fecHoraActual){ 
                $.ajax({
                    ...
                    datatype: "html",
                    url: "funciones_out2.php",
                    data: {funcion: funcion, jornada: numJor, idA: idEquiA, idB: idEquiB, golA: golA, golB: golB, fecHora: fecHora, arayIdJug: jsonidJugadoresGol, arayGoles: jsongoles},
...
<!-- DESARROLLANDING -->
                            ...
                            <div id="divFormGroupNumJugol" class="form-group">
                              <!--  <div id="divJugadores" class="col-sm-6">
                                    ...
                                    <select id="selJugadores" class="form-control" disabled>  
                                ...
                                <div id="divGoles" class="col-sm-6">
                                    ...
                                    <select id="goles" class="form-control" disabled> 
                                        <option value=''>Selecciona número de goles</option> 
                                    </select>
                                </div> -->
                            </div>
