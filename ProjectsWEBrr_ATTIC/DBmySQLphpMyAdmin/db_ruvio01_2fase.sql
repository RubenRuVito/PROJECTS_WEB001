...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-09-2014 a las 00:04:29
...
--
-- Base de datos: `db_ruvio01_2fase`
--
...
(1, 'Real Galobo C.F', 3, 1, 1, 0, 0, 5, 1),
(2, 'Mi Nabo De Kiev C.F', 3, 3, 0, 3, 0, 3, 3),
(3, 'Servillegas F.C.', 1, 1, 0, 1, 0, 2, 2),
(4, 'Los de Siempre C.F.', 0, 1, 0, 0, 1, 1, 5),
(5, 'All Blacks F.C.', 3, 3, 0, 3, 0, 3, 3),
(6, 'Celtic de Maca C.F.', 1, 1, 0, 1, 0, 2, 2);
