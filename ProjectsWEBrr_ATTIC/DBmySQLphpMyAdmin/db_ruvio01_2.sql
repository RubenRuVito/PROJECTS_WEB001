...
--
-- Servidor: localhost
-- Tiempo de generación: 15-09-2014 a las 12:28:45
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='tabla resultados,jornada y quiniela.' AUTO_INCREMENT=13 ;
...
(1, 1, 2, 5, 0, 1, NULL, 1),
(2, 3, 4, NULL, NULL, 1, NULL, 2),
(3, 5, 6, 2, 2, 1, NULL, 0),
(4, 4, 1, 2, 3, 2, NULL, 2),
(5, 2, 5, NULL, NULL, 2, NULL, 0),
(6, 6, 3, 3, 1, 2, NULL, 1),
(7, 1, 6, 4, 1, 3, NULL, 1),
(8, 3, 2, 4, 3, 3, NULL, 1),
(9, 5, 4, 2, 5, 3, NULL, 2),
(10, 4, 5, NULL, NULL, 4, NULL, NULL),
