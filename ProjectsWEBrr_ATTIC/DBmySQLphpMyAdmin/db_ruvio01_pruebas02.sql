...
--
-- Servidor: localhost
-- Tiempo de generación: 11-10-2014 a las 00:44:14
...
(1, 'Real Galobo C.F', 24, 8, 8, 0, 0, 24, 22),
(2, 'Mi Nabo De Kiev C.F', 0, 0, 0, 0, 0, 0, 0),
(3, 'Servillegas F.C.', 2, 2, 0, 2, 0, 4, 4),
(4, 'Los de Siempre C.F.', 0, 8, 0, 0, 8, 8, 10),
(5, 'All Blacks F.C.', 0, 0, 0, 0, 0, 0, 0),
(6, 'Celtic de Maca C.F.', 2, 2, 0, 2, 0, 4, 4);
...
--
-- Volcado de datos para la tabla `jugadores_goles`
--

INSERT INTO `jugadores_goles` (`idfk_jugador`, `idfk_resultado`, `goles`) VALUES
(5, 1, 1),
(9, 1, 2);
...
CREATE TABLE IF NOT EXISTS `mensajesblog` (
  ...
  KEY `idfk_user` (`idfk_user`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Tabla mensajes para noticias en realGalobo' AUTO_INCREMENT=14 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Tabla de Puntos de usuario por hacer la quiniela' AUTO_INCREMENT=3 ;

--
-- Volcado de datos para la tabla `puntos_quiniela`
--

INSERT INTO `puntos_quiniela` (`id_puntosQuini`, `idfk_user`, `puntosQuini`, `efect_quiniela`, `efect_goleadores`, `efect_total`) VALUES
(1, 1, 24, 0, 0, 0),
(2, 2, 23, 0, 0, 0);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Tabla de quinielas hechas por usuario y partidos de la jornada' AUTO_INCREMENT=4 ;

--
-- Volcado de datos para la tabla `quinielaga`
--

INSERT INTO `quinielaga` (`id_quinielaga`, `idfk_user`, `idfk_resultado`, `jornada`, `ids_goleadores`, `quiniela_user`) VALUES
(1, 1, 1, 1, '5,9,8', '2'),
(2, 1, 2, 1, '', 'x'),
(3, 1, 3, 1, '', '1');
...
(1, 1, 4, 3, 1, 1, '2014-09-27 17:00:00', '1'),
(2, 3, 6, 2, 2, 1, '2014-09-27 18:00:00', 'x'),
(3, 2, 5, NULL, NULL, 1, '2014-09-27 19:00:00', NULL),
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  PRIMARY KEY (`id_user`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Tabla usuarios principal' AUTO_INCREMENT=3 ;
